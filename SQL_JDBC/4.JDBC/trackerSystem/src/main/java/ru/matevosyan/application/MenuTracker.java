...
import ru.matevosyan.action.BaseAction;
...
//    private UserAction[] userAction = new UserAction[maxUserAction];
    ...
    private static final Logger LOG = LoggerFactory.getLogger(MenuTracker.class.getName());
    ...
    public void fillAction() {
        ...
        addAction(new CloseConnectionToDB(10, "Press y to EXIT"));
    ...
    private class CloseConnectionToDB extends BaseAction {
        private final String exit = "y";

        /**
         * use BaseAction constructor to assign the variable value created own CloseConnectionToDB constructor.
         * @param key use to assign userAction key to return it.
         * @param name use to assign userAction menu point to return it.
         */
        private CloseConnectionToDB(int key, String name) {
            super(key, name);
        }
