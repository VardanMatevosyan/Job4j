package ru.matevosyan.confingForJunit;
...
public class Settings {
    ...
    /**
     * Constructor load all settings from property file DBconfig to fileInputStream and passing to load method.
     * which call from properties object and load all from config file that we ca after use it to get our own
     * setting define in the file properties and use another methods.
     * use to load input stream.
     */

    private Settings() {
        URL urlToConfigFile = this.getClass().getClassLoader().getResource("DBJunitTestConfig.properties");
